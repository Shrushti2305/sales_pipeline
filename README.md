...
The final processed dataset is saved to: `output/final_sales.csv`
...
| product_identifier (sku) | Product SKU |
...
4. **View output:**
   The final output will be generated at: `output/final_sales.csv`
